 ...
 * @author User
 */
public class myWebdesign extends javax.swing.JFrame {

    /**
     * Creates new form myWebdesign
     */
    public myWebdesign() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Web Design Student Details");
        ...
        jLabel2.setText("IIHT WEB DESIGN STUDENT");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "5000", "10", "000", "50", "000" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        myMenu buf = new myMenu();        // TODO add your handling code here:
        buf.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(myWebdesign.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new myWebdesign().setVisible(true);
            }
        });
    }
